...
I will be replicating the behavioral data in Figures 5d-e and Extended Data Figures 7d-h, since these are the only data in which statistical tests were done beyond standard error calculation.
...
Let's read in the associated data tables, starting with Figure 5d:
